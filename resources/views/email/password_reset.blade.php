                              ...
                              <td colspan="2">
                                <div style="line-height:1.6">
                                  <div style="font-size:16px; display:block;">
                                    <p style="text-align: justify;">Bạn nhận được email này vì chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn hãy <a href="{{ env('APP_URL_FE', 'http://danangtravel.ddns.net') . "/admin/forget-password/change-password/{$info['token']}" }}"  style="font-size: 25px"><b>BẤM VÀO ĐÂY</b></a> để đặt lại mật khẩu</p>
