                              ...
                              <td colspan="2">
                                <div style="line-height:1.6">
                                  <div style="font-size:16px; display:block;">
                                    <p style="text-align: justify;">Bạn nhận được mail này vì Quản trị viên đã không phê duyệt cho bạn bởi một vài lí do khách quan nào đó.</p>
                                    @if(!empty($info['reason']))
                                      <p style="text-align: justify; color:red;">Lí do: {{ $info['reason'] }}</p>
                                    @endif
                                  </div>
                                </div>
                              </td>
